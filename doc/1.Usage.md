...
//
// localhost:80 will be used if you do not provide any args
//
new Klient();
...
Once configured, the Klient instance can be used to execute request to your webservice. The request will be constructed by the service "factory". The Request class is a Promise that use the service "dispatcher" to emit events during its lifecycle. By default, the returned Promise will be resolved as Axios does.

Find all the available methods and properties in the [Klient API documentation](./6.API.md#klient-instance).
...
//
// Execute a request with "verb" methods
//
...
request.config.headers.Authorization = 'Bearer test';
...
**[TOC](./0.TOC.md) &emsp; >> &emsp; [Introduction](../README.md) &emsp; >> &emsp; Usage &emsp; >> &emsp; [Events](./2.Events.md) &emsp; >> &emsp; [Request](./3.Request.md) &emsp; >> &emsp; [Extensions](./4.Extensions.md) &emsp; >> &emsp; [Utilities](./5.Utilities.md) &emsp; >> &emsp; [API](./6.API.md)**
